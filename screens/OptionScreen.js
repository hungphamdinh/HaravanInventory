    ...
    return (
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        {this.state.optionView.map((option) => {
          return <OptionCard key={option.id}
            option={option}
  ...
  return (
    <View style={styles.mCard} >
      ...
      <View style={styles.descriptArea}>
        ...
        <Text numberOfLines={2} style={styles.textStyle}>{props.option.last_message_content}</Text>
      </View>
      <View style={styles.btnArea}>
          <TouchableOpacity style={styles.btnRegister} onPress={()=>props.onConversationGo(props.option.id)}>
